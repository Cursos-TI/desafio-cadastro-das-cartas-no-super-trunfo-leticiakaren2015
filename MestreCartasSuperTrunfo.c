...
//==========================================
printf("======== Resultado da Carta 1 em relação a cata 2========\n");   // Resultado da carta 1 em relação a carta 2 ('1' ganhou, '0' perdeu).
printf("*** Resultado '1' venceu, '0' perdeu!!! ***\n");
printf("População: (%d)\n", populacao1 > populacao2);
printf("Área: (%d)\n", area1 > area2);
printf("PIB: (%d)\n", pib1 > pib2);
printf("Pontos Turístico: (%d)\n", pontosTuristicos1 > pontosTuristicos2);
printf("Densidade Populacional: (%d)\n", densidade1 > densidade2);      //Densidade populacional (menor vence!)
